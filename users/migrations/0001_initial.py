    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('materia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materia_semestres', to='users.materiasmodels')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idiomas_dominas', models.CharField(choices=[('E', 'ESPAÑOL'), ('1', 'INGLES')], max_length=10)),
