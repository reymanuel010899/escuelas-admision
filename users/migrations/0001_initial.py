    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materia', models.ManyToManyField(blank=True, related_name='materia_semestres', to='users.materiasmodels')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Secion', models.CharField(blank=True, max_length=35, null=True)),
                ('estado_civil', models.CharField(blank=True, choices=[('s', 'SOLTERO'), ('c', 'CASADO'), ('u', 'UNION LIBRE')], max_length=20, null=True)),
                ('no_cedula', models.CharField(blank=True, max_length=15, null=True)),
                ('telefono_res', models.CharField(blank=True, max_length=20, null=True)),
                ('direcion', models.CharField(blank=True, max_length=150, null=True)),
                ...
                ('lugar_trabajo', models.CharField(blank=True, max_length=75, null=True)),
                ('alguna_discapasidad', models.CharField(blank=True, max_length=20, null=True)),
                ('tipo_sangre', models.CharField(blank=True, max_length=25, null=True)),
                ('funcion_desenpeña', models.CharField(blank=True, max_length=100, null=True)),
                ('correo', models.EmailField(blank=True, max_length=254, null=True)),
                ('alergico', models.CharField(blank=True, max_length=50, null=True)),
                ('sexo', models.CharField(blank=True, choices=[('m', 'MASCULINO'), ('f', 'FEMENINO')], max_length=20, null=True)),
                ('militar', models.BooleanField(blank=True, default=False, null=True)),
